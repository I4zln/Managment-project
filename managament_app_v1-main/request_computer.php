...
<div class="question-container">
    ...
    <div class="question-text">
        <label for="computer-count" class="question-label">عدد الأجهزة المكتبية المطلوبة</label>
        <input type="number" name="device_qty" value="<?php echo $desktop_device_count; ?>" id="computer-count" placeholder="الرجاء إدخال العدد" class="answer-input">
    </div>
</div>
...
<div class="question-container">
    ...
    <div class="question-text">
        <label for="laptop-count" class="question-label">عدد الأجهزة المحمولة المطلوبة</label>
        <input type="number" name="laptop_qty" value="<?php echo $laptop_device_count; ?>" id="laptop-count" placeholder="الرجاء إدخال العدد" class="answer-input">
    </div>
</div>

<!-- Question 10 - Last Question: سبب الاحتياج -->
<div class="question-container">
...
<div id="popupModal" class="modal-overlay">
    <div class="modal-box">
        <div class="modal-message">
            الاجهزة المعاد تدوريها من قبل مهندسي وحده صيانة الحاسب الالي بورشة المستلزمات التعليمية و التقنية
        </div>
        <div class="modal-buttons">
            <button class="modal-button yes-button" onclick="proceed()">نعم</button>
            <button class="modal-button no-button" onclick="goHome()">لا</button>
        </div>
    </div>
</div>
...
<style>
    ...
    .modal-box {
        background-color: #f0f0f0; /* Change this to match your site's theme */
        padding: 30px;
        text-align: center;
        border: 3px solid #4CAF50; /* Border color */
        border-radius: 10px;
        max-width: 500px;
        width: 90%;
